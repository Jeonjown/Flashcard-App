    ...
    <>
      <div className="fixed hidden h-full bg-white p-4 shadow-md md:col-span-3 md:block lg:col-span-2">
        ...
        <div className="p-4 text-xl md:p-5 md:text-2xl">
          ...
          <Link to={"/test"}>
            <div className="mb-10 mt-2 flex items-center hover:cursor-pointer hover:bg-secondary-200">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
          ...
          <div className="mt-8 flex items-center border-t-2 text-primary hover:cursor-pointer hover:bg-secondary-200">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
